...
#
# Копия лежит на той же машине, что и ячейка. Это защищает от удаления
# и от порчи данных, но не от потери машины: увозить каталог бэкапов
# на другой носитель — отдельный шаг, и он за пределами этого скрипта.
#
