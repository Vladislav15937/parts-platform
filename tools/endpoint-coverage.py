...
# Третье — не оправдание, а очередь работы: список обязан пустеть. На 3 сентября
# 2026 он пуст: три пробела (место машины, приход партии и её состав) закрыты
# экранами, четвёртый раз подряд оказавшись «написано, покрыто тестами,
# недоступно».
KNOWN = {
