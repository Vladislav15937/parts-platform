    ...
    for cs in changesets:
        ...
        for f in found:
            ...
            problems.append(
                ...
                f"не пройдёт. Сужайте по expand/contract: сначала релиз, где код\n"
                f"      перестал это использовать, удаление — не раньше, чем "
                f"написано в db/CLAUDE.md. Тогда допишите в changeset\n"
