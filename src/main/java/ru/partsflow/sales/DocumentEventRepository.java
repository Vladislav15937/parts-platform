...
/**
 * Событие документа — журнал, и он неизменяем.
 *
 ...
 */
public interface DocumentEventRepository extends Repository<DocumentEvent, Long> {

    List<DocumentEvent> findByDocumentTypeAndDocumentIdOrderByIdAsc(
            String documentType, Long documentId);

    DocumentEvent save(DocumentEvent event);
}
