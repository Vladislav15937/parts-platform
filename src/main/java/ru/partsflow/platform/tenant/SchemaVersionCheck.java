...
public class SchemaVersionCheck implements ApplicationRunner {
    ...
    /**
     * Отдельно от {@link #run}, чтобы проверку можно было доказать вызовом.
     * Через подъём контекста её не проверить: реестр надо испортить до старта,
     * а свойство-маркер ради этого — ещё один кэшированный контекст Spring
     * и ещё один пул соединений на прогон.
     */
    void report() {
