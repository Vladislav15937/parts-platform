 ...
 * просто бросили, не закрывает ничего: человек ушёл, и больше с ней никто
 * не приходит.
 *
 * <p><b>С задачи 0080 перезапуск сессий больше не уносит</b> — они лежат
 * в общей схеме ячейки, — и уборки это не отменяет, а делает её честнее:
 * раньше половину призраков наживал сам перезапуск, теперь остаются только
 * настоящие брошенные.
 *
