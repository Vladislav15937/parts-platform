...
public class LoginSessions {
    ...
    /**
     * Уборка зависших: человек бросил вкладку, запись осталась открытой.
     * Перезапуск сюда больше ничего не добавляет — с задачи 0080 сессии живут
     * в общей схеме ячейки и его переживают.
     *
