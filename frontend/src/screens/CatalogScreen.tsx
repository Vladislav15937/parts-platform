    ...
    <section className="screen screen--wide">
      ...
      <div className="filter-row">
        ...
        {/* Ссылкой, а не кнопкой с запросом: файл на двенадцать мегабайт
            ...
            Витрину смотрят все вошедшие, а скачивают её файлом — владелец
            и менеджер: опись всего склада уносится одним нажатием.
            Сторожем остаётся сервер (`CatalogController.EXPORTS`) —
            спрятанная кнопка при открытом адресе это не защита. */}
