 ...
 * @param query  поиск: номер сделки и номер позиции точно, клиент
 *               и публичный код детали — вхождением. Номер позиции (0069) —
 *               то, с чего начинается звонок: «мне звонили, позиция 347»;
 *               «№ 347» понимается так же, как «347»
